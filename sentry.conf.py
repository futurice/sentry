...
# SSO
MIDDLEWARE_CLASSES += (
'auth.ProxyHeaderMiddleware',
)

AUTHENTICATION_BACKENDS = (
'auth.OrganizationUserBackend',
)

SENTRY_OPTIONS.update({
    'system.url-prefix': env('SENTRY_URL_PREFIX'),
})

SENTRY_DEFAULT_ROLE = 'manager'
# DSNs
SENTRY_ENDPOINT = env('ENDPOINT', 'http://sentry:8000')
SENTRY_PUBLIC_ENDPOINT = env('SENTRY_URL_PREFIX')
